 ...
 */
class Version20180711090626 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE carte ADD id_user INT DEFAULT NULL');
        $this->addSql('ALTER TABLE carte ADD CONSTRAINT FK_BAD4FFFD6B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateurs (id)');
        $this->addSql('CREATE INDEX IDX_BAD4FFFD6B3CA4B ON carte (id_user)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE carte DROP FOREIGN KEY FK_BAD4FFFD6B3CA4B');
        $this->addSql('DROP INDEX IDX_BAD4FFFD6B3CA4B ON carte');
        $this->addSql('ALTER TABLE carte DROP id_user');
    }
}
